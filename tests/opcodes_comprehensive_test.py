...
class TestEXTOpcodes:
    ...
    class TestLogShift:
        """Tests for log_shift opcode (EXT:2)."""

        def test_log_shift_left(self, cpu_v5):
            """Test log_shift: logical shift left."""
            cpu = cpu_v5
        ...
        def test_log_shift_right(self, cpu_v5):
            """Test log_shift: logical shift right."""
            cpu = cpu_v5
            mem = self._setup_ext(cpu, 2)
    ...
    class TestArtShift:
        """Tests for art_shift opcode (EXT:3)."""

        def test_art_shift_left(self, cpu_v5):
            """Test art_shift: arithmetic shift left."""
            cpu = cpu_v5
        ...
        def test_art_shift_right_negative(self, cpu_v5):
            """Test art_shift: arithmetic shift right (preserves sign)."""
            cpu = cpu_v5
            mem = self._setup_ext(cpu, 3)
